        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">         
          ...
          <li class="layui-nav-item" lay-unselect>
            <a href="javascript:;">
              ...
              <cite><img src="img/${user[0].Url }" style="width: 20px;height: 20px;" class="layui-nav-img">${user[0].Uname }</cite>
            </a>
            <dl class="layui-nav-child">
              <dd><a lay-href="getuser.do">基本资料</a></dd>

              <dd><a lay-href="upd.do">修改密码</a></dd>

              <dd style="text-align: center;"><a href="logout.do">退出</a></dd>
            </dl>
          </li>
				...
				for(var j=0;j<firstMenu.length;j++){
					...
					if(sonMenu.length>0){		
						...
						for(var k=0;k<sonMenu.length;k++){		
								menu+="<dd><a href='javascript:;'>"+sonMenu[k].PermName+"</a>";
						...
						menu+="<i class='"+firstMenu[j].micon+"' style='font-size:20px;'></i>";
						menu+="<cite>"+firstMenu[j].PermName+"</cite></a>";	
					}
					menu+="</li>";
				}
